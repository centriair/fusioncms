      ...
      <div
        ...
        <div class="right-container hidden md:block">
          <nav class="flex gap-x-8">
            <div class="font-light"><a {{ url('/') }}>Home</a></div>
            <div class="font-light"><a {{ url('about-us') }}>About Us</a></div>
            <div class="font-bold flex items-center gap-x-2">
              ...
              <a {{ url('our-plans') }}>Our Plans</a>
            </div>
            <div class="font-light"><a {{ url('our-services') }}>Other Services</a></div>
            <div class="font-light"><a {{ url('contact-us') }}>Contact Us</a></div>
          </nav>
        </div>
  ...
  <section class="our-plans-section  mb-20 md:mb-40">
    <div class=" w-full max-w-screen-sm md:max-w-screen-lg mx-auto px-8 text-base gap-x-2 py-4">
      ...
      <div class="fade-in-element up flex flex-wrap pb-4 md:pb-8">
        <div class="flex flex-col sm:w-1/2 md:w-1/3 my-3 md:pr-4 sm:pr-4">
          <div class="logo flex flex-wrap justify-center mb-8">
            <img class="object-contain w-10/12 mb-5" src="{{ url('theme/assets/photos/aircon-midea.png') }}">
            <img class="h-10 object-contain" src="{{ url('theme/assets/brands/logo-midea.png') }}">
          </div>
          <div class="grid-item h-full border-card-outline-grey border-2 rounded-xl">
            <div class="card flex flex-col">
              <div class="relative top-card rounded-t-xl bg-gradient-to-b from-medium-grey to-white-grey py-8">
                <!-- <div class="absolute top-1 right-1.5"><img class="w-12" src="{{ url('theme/assets/4-star.png') }}"/></div> -->
        ...
        <div class="flex flex-col sm:w-1/2 md:w-1/3 my-3 md:px-4 sm:px-4">
          <div class="logo flex flex-wrap justify-center mb-8">
            <img class="object-contain w-10/12 mb-5" src="{{ url('theme/assets/photos/aircon-panasonic.png') }}">
            <img class="h-10 object-contain" src="{{ url('theme/assets/brands/logo-panasonic.png') }}">
          </div>
          <div class="grid-item h-full border-card-outline-grey border-2 rounded-xl">
            <div class="card flex flex-col">
              <div class="relative top-card rounded-t-xl bg-gradient-to-b from-medium-grey to-white-grey py-8">
        ...
        <div class="flex flex-col sm:w-1/2 md:w-1/3 my-3 md:pl-4 sm:pl-4">
          <div class="logo flex flex-wrap justify-center mb-8">
            <img class="object-contain w-10/12 mb-5" src="{{ url('theme/assets/photos/aircon-daikin.png') }}">
            <img class="h-10 object-contain" src="{{ url('theme/assets/brands/logo-daikin.png') }}">
          </div>
          <div class="grid-item h-full border-card-outline-grey border-2 rounded-xl">
            <div class="card flex flex-col">
              <div class="relative top-card rounded-t-xl bg-gradient-to-b from-medium-grey to-white-grey py-8">
                <!-- <div class="absolute top-1 right-1.5"><img class="w-12" src="{{ url('theme/assets/5-star.png') }}"/></div> -->
                <div class="top-card-item text-center">
                  <div class="text-xl font-light">
                    <p>1.0HP</p>
                  </div>
